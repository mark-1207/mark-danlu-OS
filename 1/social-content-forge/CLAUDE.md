...
当前进行 v2 升级设计，详见 `docs/superpowers/specs/2026-03-31-social-content-forge-v2-design.md`

## 启动时检查

**每次 cd 到本项目目录时，自动执行：**

1. 检查 `docs/style-library/library.json` 是否有新增案例
2. 如检测到新案例（good/ 或 bad/ 目录下有新增文件），自动学习并总结
3. 输出学习洞察报告，找用户确认
4. 用户确认后，更新 `docs/memory/content-quality.md` 中的内容质量标准

**风格学习库存放位置：** `docs/style-library/`
