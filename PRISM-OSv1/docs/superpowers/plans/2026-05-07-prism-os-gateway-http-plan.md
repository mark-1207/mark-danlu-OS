...
```bash
# 启动服务（后台）
GATEWAY_AUTH_KEY=test-secret OPENROUTER_API_KEY=sk-or-v1-xxx node dist/http-server.js &
GATEWAY_PID=$!
sleep 2
...
OPENROUTER_API_KEY=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 \
