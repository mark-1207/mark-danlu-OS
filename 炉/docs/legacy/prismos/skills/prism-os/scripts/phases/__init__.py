...
from .direction_select import DirectionSelectPhase
...
class FullPrismPipeline(PrismPipeline):
    ...
    def phases(self) -> list:
        phases = [
            ...
            IntentPhase(),
            GatewayPhase(),
            DirectionSelectPhase(),  # v1.1: 网关 pass 后方向选择
            BackupCheckPhase(),
            PrismPhase(),
            RealityPhase(),
            # V1.5 扩展（必经）
...
__all__ = [
    ...
    "FullPrismPipeline",
    "IntentPhase", "GatewayPhase", "DirectionSelectPhase",
    "BackupCheckPhase", "PrismPhase",
