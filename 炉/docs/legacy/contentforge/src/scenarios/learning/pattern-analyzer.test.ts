      ...
      const records: FeishuRecord[] = [
        {
          record_id: '1',
          fields: {
            原文标题: 't1', 平台: 'wechat', 叙事结构: '对比型', 情感调性: '励志',
            阅读数: 1000, 点赞数: 80, 评论数: 10, 转发数: 5, 收藏数: 5,
            标签: [], 状态: 'analyzed', 原始链接: '', 来源类型: 'crawled', 收藏: false, 抓取时间: '2026-01-01',
          },
        },
        {
          record_id: '2',
          fields: {
            原文标题: 't2', 平台: 'wechat', 叙事结构: '对比型', 情感调性: '冷静',
        ...
        },
        {
          record_id: '3',
          fields: {
            原文标题: 't3', 平台: 'wechat', 叙事结构: '清单型', 情感调性: '励志',
      ...
      const records: FeishuRecord[] = [
        {
          record_id: '1',
          fields: {
            原文标题: 't1', 平台: 'wechat', 叙事结构: '故事型', 情感调性: '温暖',
